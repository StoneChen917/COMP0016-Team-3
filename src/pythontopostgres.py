...
def save_data(data):
    ...
    disaster_insert_script = ''' INSERT INTO Disaster (admin0, admin1, admin2, operation_number, glide_number, host_national_society, operation_budget, 
                          operation_start_date, operation_end_date, number_of_people_affected, number_of_people_assisted,
                          admin_2_code) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'''
